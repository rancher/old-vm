...
import (
	v1alpha1 "github.com/rancher/vm/pkg/client/clientset/versioned/typed/ranchervm/v1alpha1"
...
func (c *FakeVirtualmachineV1alpha1) MachineImages() v1alpha1.MachineImageInterface {
	return &FakeMachineImages{c}
}
