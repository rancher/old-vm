...
var settingsResource = schema.GroupVersionResource{Group: "virtualmachine.rancher.com", Version: "v1alpha1", Resource: "settings"}

var settingsKind = schema.GroupVersionKind{Group: "virtualmachine.rancher.com", Version: "v1alpha1", Kind: "Setting"}
...
func (c *FakeSettings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Setting, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(settingsResource, name, data, subresources...), &v1alpha1.Setting{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Setting), err
